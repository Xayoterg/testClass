...
/**
 * Factory class to get sample list of flights.Фабричный класс, чтобы получить примерный список рейсов
 */
class FlightBuilder {
    ...
    private static Flight createFlight(final LocalDateTime... dates) {
        if ((dates.length % 2) != 0) {
            throw new IllegalArgumentException(
                    "you must pass an even number of dates вы должны пройти четное количество свиданий");
        }
...
/**
 * Bean that represents a flight segment.Бин, представляющий полетный сегмент.
 */
class Segment {
